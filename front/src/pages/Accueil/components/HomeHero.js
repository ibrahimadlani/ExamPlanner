export default function HomeHero() {
  return (
        <main className="my-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">Plannifer en un clic, </span>{' '}
              <span className="block text-red-600 xl:inline">tout vos examens</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            ExamPlanner est une plateforme qui offre aux utilisateurs la possibilité de générer des planning d'examens suivant certaines stratégies décisionnelles.
            </p>
