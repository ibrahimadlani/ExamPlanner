...
import com.greglturnquist.payroll.Model.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        Matiere economie = new Matiere("Économie","Ensemble des activités d'une collectivité humaine relatives à la production, à la distribution et à la consommation des richesses", alcide_faucheron,90);
        ...
        Matiere mathematique = new Matiere("Mathématique","Mathematics is an area of knowledge that includes topics as numbers, formulas and related structures, shapes and the spaces in which they are contained, and quantities and their changes.", maxence_duconseil,120);
        Matiere unity = new Matiere("Unity","Unity is a cross-platform game engine developed by Unity Technologies, first announced and released in June 2005 at Apple Worldwide Developers Conference as a Mac OS X game engine.", nadir_yala,120);
        ...
        Matiere arduino = new Matiere("Arduino","Arduino is an open-source hardware and software company, project, and user community that designs and manufactures single-board microcontrollers and microcontroller kits for building digital devices.", esther_lawson,90);
        ...
        Matiere data_mining = new Matiere("Data Mining","Data mining is the process of extracting and discovering patterns in large data sets involving methods at the intersection of machine learning, statistics, and database systems.", alcide_faucheron,90);
        ...
        Planning planing_novembre_1 = new Planning(LocalDateTime.of(2022,12,05, 0,0),LocalDateTime.of(2022,12,12,0,0), list_indisponibilites, 8,0, 17,0,toutes_matieres);
        Planning planing_novembre_2= new Planning(LocalDateTime.of(2022,12,05, 0,0),LocalDateTime.of(2022,12,12,0,0), list_indisponibilites, 8,0, 17,0,toutes_matieres);
        ...
        Planning planing_novembre_4 = new Planning(LocalDateTime.of(2022,12,05, 0,0),LocalDateTime.of(2022,12,12,0,0), list_indisponibilites, 8,0, 17,0,toutes_matieres);

        //Génération
        //planing_novembre_3.generate();

        List<Integer> listofPossibleHeaps
                = PlanningGeneration.getPossibleStates(8);

        //System.out.println(listofPossibleHeaps);

        MiniMax miniMax = new MiniMax();

        miniMax.constructTree(6);
        Node result = miniMax.checkWin();
